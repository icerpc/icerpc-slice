...
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Compiler           | A Slice compiler such as [slicec] compiles Slice files into Compiler definitions serialized to stdout. These definitions are then decoded and consumed by code generators.                                                                                                     |
| Ice                | Types and interfaces provided for interop with [Ice] applications.                                                                                                                                                                                                             |
